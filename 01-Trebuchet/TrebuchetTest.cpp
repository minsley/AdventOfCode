...
const char* example1 = R"(1abc2
pqr3stu8vwx
a1b2c3d4e5f
treb7uchet)";

const char* example2 = R"(two1nine
eightwothree
abcone2threexyz
xtwone3four
4nineeightseven2
...
TEST_SUITE("01 Trebuchet") {
    TEST_CASE("Example 1") {
        CHECK(Trebuchet::solve1(example1) == 142);
    }

    TEST_CASE("Part 1") {
        CHECK(Trebuchet::solve1(input) == 55017);
    }

    TEST_CASE("Example 2") {
        CHECK(Trebuchet::solve2(example2) == 281);
    }

    TEST_CASE("Part 2") {
        CHECK(Trebuchet::solve2(input) == 53539);
    }
}