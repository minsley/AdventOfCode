...
#ifndef TREBUCHETTEST_H
#define TREBUCHETTEST_H
...
const char* TrebuchetTest::example1 = R"(1abc2
pqr3stu8vwx
a1b2c3d4e5f
treb7uchet)";

const char* TrebuchetTest::example2 = R"(two1nine
eightwothree
abcone2threexyz
xtwone3four
4nineeightseven2
...
const char* TrebuchetTest::input = R"(5ffour295
