...
const char* example1 = R"(Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
...
const char * input = R"(Game 1: 10 red, 7 green, 3 blue; 5 blue, 3 red, 10 green; 4 blue, 14 green, 7 red; 1 red, 11 green; 6 blue, 17 green, 15 red; 18 green, 7 red, 5 blue
...
TEST_SUITE("02 Cube Conundrum") {
    TEST_CASE("Example 1") {
        CHECK(CubeConundrum::solve1(example1) == 8);
    }

    TEST_CASE("Part 1") {
        // CHECK(CubeConundrum::solve1(input) == 55017);
    }

    TEST_CASE("Example 2") {
        // CHECK(CubeConundrum::solve2(example2) == 281);
    }

    TEST_CASE("Part 2") {
        // CHECK(CubeConundrum::solve2(input) == 53539);
    }
}